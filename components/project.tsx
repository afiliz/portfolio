...
export default function Project({title, description, tags, imageUrl}: 
  ...
  return (
    ...
    >
      <section
        className="relative bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 sm:h-[20rem] rounded-lg group-even:pl-8 hover:bg-gray-200 transition">
        ...
        <Image src={imageUrl} alt={description} quality={95} className='absolute top-8 -right-40 w-[28.25rem] rounded-t-lg shadow-2xl group-even:right-[initial] 
        transition
